...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Class: FileFactory</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
          ...
          <ul class="nav bs-sidenav">
                  ...
                  <li class="active">
                      ...
                      <ul class="nav">
                          ...
                          <li class="active"><a href="binding.FileFactory.html" class="nav-name">FileFactory</a></li>
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Class: FileFactory</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="binding.html">binding</a>.</span>FileFactory<span class="signature">(properties<span class="signature-attributes">opt</span>, &hellip;arguments)</span><span class="type-signature"> &rarr; {<a href="binding.File.html">binding.File</a>}</span></h2>
...
<article>
    ...
    <h4 class="name" id="FileFactory"><span class="type-signature"></span>new FileFactory<span class="signature">(properties<span class="signature-attributes">opt</span>, &hellip;arguments)</span><span class="type-signature"> &rarr; {<a href="binding.File.html">binding.File</a>}</span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>initial properties to set on the file</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line11">line 11</a>
    </li></ul></dd>
...
<span class="param-type"><a href="binding.File.html">binding.File</a></span>
    ...
    <ul>
        <li><a href="binding.Factory.html">binding.Factory</a></li>
    </ul>
    ...
    <h4 class="name" id="create"><span class="type-signature"></span>create<span class="signature">(db)</span><span class="type-signature"> &rarr; {<a href="binding.FileFactory.html">binding.FileFactory</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line27">line 27</a>
    </li></ul></dd>
...
<span class="param-type"><a href="binding.FileFactory.html">binding.FileFactory</a></span>
    ...
    <h4 class="name" id="fromJSON"><span class="type-signature"></span>fromJSON<span class="signature">(json)</span><span class="type-signature"> &rarr; {<a href="binding.File.html">binding.File</a>}</span></h4>
...
<span class="param-type">json</span>
            ...
            <td class="description last"><p>The file metadata as json</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line51">line 51</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The deserialize File instance</p>
</div>
...
<span class="param-type"><a href="binding.File.html">binding.File</a></span>
    ...
    <h4 class="name" id="listBuckets"><span class="type-signature"></span>listBuckets<span class="signature">(doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;binding.File>>}</span></h4>
...
<span class="param-type"><a href="binding.FileFactory.html#~fileListCallback">binding.FileFactory~fileListCallback</a></span>
            ...
            <td class="description last"><p>The callback is invoked with the listed buckets</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line115">line 115</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;Array.&lt;binding.File>></span>
    ...
    <h4 class="name" id="listFiles"><span class="type-signature"></span>listFiles<span class="signature">(folderOrPath, start, count, doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;Array.&lt;binding.File>>}</span></h4>
...
<table class="params table">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>folderOrPath</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The folder/path to list.</p></td>
        </tr>
...
<span class="param-type"><a href="binding.File.html">binding.File</a></span>
            ...
            <td class="description last"><p>The file/folder from where to start listing (not included)</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The maximum number of files to return.</p></td>
        </tr>
...
<span class="param-type"><a href="binding.FileFactory.html#~fileListCallback">binding.FileFactory~fileListCallback</a></span>
            ...
            <td class="description last"><p>The callback is invoked with the listed files</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line131">line 131</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;Array.&lt;binding.File>></span>
    ...
    <h4 class="name" id="loadMetadata"><span class="type-signature"></span>loadMetadata<span class="signature">(bucket, options<span class="signature-attributes">opt</span>, doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;Object.&lt;string, util.Permission>>}</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The name of the root file directory</p></td>
        </tr>
...
<span class="param-type"><a href="binding.FileFactory.html#~bucketMetadataCallback">binding.FileFactory~bucketMetadataCallback</a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line90">line 90</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>A promise which will be fulfilled with the bucket acls</p>
</div>
...
<span class="param-type">Promise.&lt;Object.&lt;string, util.Permission>></span>
    ...
    <h4 class="name" id="new"><span class="type-signature"></span>new<span class="signature">(fileOptions)</span><span class="type-signature"> &rarr; {<a href="binding.File.html">binding.File</a>}</span></h4>
...
<div class="description">
    <p>Creates a new file object which represents the file at the given ID</p>
<p>Data provided to the constructor will be uploaded by invoking <code>upload()</code>.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The fileOptions used to create a new file object, or just the id of the<br>file object</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line149">line 149</a>
    </li></ul></dd>
...
<span class="param-type"><a href="binding.File.html">binding.File</a></span>
    ...
    <h4 class="name" id="newInstance"><span class="type-signature"></span>newInstance<span class="signature">(args<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="binding.File.html">binding.File</a>}</span></h4>
...
<span class="param-type">Array.&lt;*></span>
            ...
            <td class="description last"><p>Constructor arguments used for instantiation, the constructor will not be called<br>when no arguments are passed</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line40">line 40</a>
    </li></ul></dd>
...
<span class="param-type"><a href="binding.File.html">binding.File</a></span>
    ...
    <h4 class="name" id="saveMetadata"><span class="type-signature"></span>saveMetadata<span class="signature">(bucket, metadata, doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;void>}</span></h4>
...
<span class="param-type">Object.&lt;string, util.Permission></span>
            ...
            <td class="description last"><p>The new metadata for the bucket</p></td>
        </tr>
...
<span class="param-type"><a href="util.Permission.html">util.Permission</a></span>
            ...
            <td class="description last"><p>The load permission which grants read access to all stored<br>files under the specified bucket</p></td>
        </tr>
...
<span class="param-type"><a href="util.Permission.html">util.Permission</a></span>
            ...
            <td class="description last"><p>The insert permission which is required to insert new<br>files into the bucket</p></td>
        </tr>
...
<span class="param-type"><a href="util.Permission.html">util.Permission</a></span>
            ...
            <td class="description last"><p>The update permission which is required to update existing<br>files within the bucket</p></td>
        </tr>
...
<span class="param-type"><a href="util.Permission.html">util.Permission</a></span>
            ...
            <td class="description last"><p>The delete permission which is required to delete existing<br>files within the bucket</p></td>
        </tr>
...
<span class="param-type"><a href="util.Permission.html">util.Permission</a></span>
            ...
            <td class="description last"><p>The query permission which is required to list all files<br>within a bucket</p></td>
        </tr>
...
<span class="param-type"><a href="binding.FileFactory.html#~bucketMetadataCallback">binding.FileFactory~bucketMetadataCallback</a></span>
            ...
            <td class="description last"><p>Invoked if the operation succeeds</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line75">line 75</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>A promise which will fulfilled with the updated metadata</p>
</div>
...
<span class="param-type">Promise.&lt;void></span>
    ...
    <h4 class="name" id="~bucketMetadataCallback"><span class="type-signature"></span>bucketMetadataCallback<span class="signature">(bucketMetadata)</span><span class="type-signature"> &rarr; {*}</span></h4>
...
<div class="description">
    <p>The list files callback is called, with the bucket metadata</p>
</div>
...
<table class="params table">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>bucketMetadata</code></td>
...
<span class="param-type">Object.&lt;string, util.Permission></span>
            ...
            <td class="description last"><p>the bucket metadata</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line178">line 178</a>
    </li></ul></dd>
...
<span class="param-type">*</span>
    ...
    <h4 class="name" id="~fileListCallback"><span class="type-signature"></span>fileListCallback<span class="signature">(files)</span><span class="type-signature"> &rarr; {*}</span></h4>
...
<div class="description">
    <p>The list files callback is called, with the loaded files</p>
</div>
...
<span class="param-type">Array.&lt;binding.File></span>
            ...
            <td class="description last"><p>The listed files</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_FileFactory.js.html">lib/binding/FileFactory.js</a>, <a href="lib_binding_FileFactory.js.html#line185">line 185</a>
    </li></ul></dd>
