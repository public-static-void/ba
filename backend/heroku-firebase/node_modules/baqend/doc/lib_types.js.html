...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Source: lib/types.js</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Source: lib/types.js</h1>
 ...
 *
 * @class
 * @name RealtimeEvent&lt;T>
 */

/**
 * the query on which .eventStream([options]) was invoked
 *
 * @memberOf RealtimeEvent&lt;T>.prototype
 * @name target
 * @type query.Node&lt;T>
 */
