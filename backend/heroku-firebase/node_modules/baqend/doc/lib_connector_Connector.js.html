...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Source: lib/connector/Connector.js</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Source: lib/connector/Connector.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/* eslint-disable no-restricted-globals */
