...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Class: TokenStorage</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
          ...
          <ul class="nav bs-sidenav">
                  ...
                  <li class="active">
                      ...
                      <ul class="nav">
                          ...
                          <li class="active"><a href="util.TokenStorage.html" class="nav-name">TokenStorage</a></li>
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Class: TokenStorage</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="util.html">util</a>.</span>TokenStorage<span class="signature">(origin, token, temporary<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="TokenStorage"><span class="type-signature"></span>new TokenStorage<span class="signature">(origin, token, temporary<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The origin where the token belongs to</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The initial token</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If the token should be saved temporary or permanently</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line22">line 22</a>
    </li></ul></dd>
...
<h4 class="name" id=".GLOBAL"><span class="type-signature">(static) </span>GLOBAL<span class="type-signature"> :<a href="util.TokenStorageFactory.html">util.TokenStorageFactory</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line167">line 167</a>
    </li></ul></dd>
...
<h4 class="name" id=".WEB_STORAGE"><span class="type-signature">(static) </span>WEB_STORAGE<span class="type-signature"> :<a href="util.TokenStorageFactory.html">util.TokenStorageFactory</a></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line224">line 224</a>
    </li></ul></dd>
...
<h4 class="name" id="temporary"><span class="type-signature"></span>temporary<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>Indicates if the token should keep temporary only or should be persisted for later sessions</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line65">line 65</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line42">line 42</a>
    </li></ul></dd>
...
<h4 class="name" id="tokenData"><span class="type-signature"></span>tokenData<span class="type-signature"></span></h4>




<div class="description">
    <p>The actual stored token</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line59">line 59</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".parse"><span class="type-signature">(static) </span>parse<span class="signature">(token)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The token string to parse, time values are returned as timestamps</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line28">line 28</a>
    </li></ul></dd>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="_saveToken"><span class="type-signature">(abstract, protected) </span>_saveToken<span class="signature">(origin, token, temporary)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>Use TokenStorage#saveToken instead</li></ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line97">line 97</a>
    </li></ul></dd>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="saveToken"><span class="type-signature">(abstract, protected) </span>saveToken<span class="signature">(origin, token, temporary)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line77">line 77</a>
    </li></ul></dd>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="signPath"><span class="type-signature"></span>signPath<span class="signature">(resource)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The resource which will be accessible with the returned token</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line121">line 121</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>A resource token which can only be used to access the specified resource</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="update"><span class="type-signature"></span>update<span class="signature">(token)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The token to store or <code>null</code> to remove the token</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_TokenStorage.js.html">lib/util/TokenStorage.js</a>, <a href="lib_util_TokenStorage.js.html#line104">line 104</a>
    </li></ul></dd>
