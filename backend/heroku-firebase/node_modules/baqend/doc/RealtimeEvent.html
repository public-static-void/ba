...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Class: RealtimeEvent<T></title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
    <div class="row">
      ...
      <div class="bs-sidebar hidden-print fixed affix" role="complementary">
          ...
          <ul class="nav bs-sidenav">
                      ...
                      <li class="active"><a href="RealtimeEvent.html" class="nav-name">RealtimeEvent</a></li>
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Class: RealtimeEvent<T></h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RealtimeEvent<T><span class="signature">()</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="RealtimeEvent<T>"><span class="type-signature"></span>new RealtimeEvent<T><span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line1">line 1</a>
    </li></ul></dd>
...
<h4 class="name" id="data"><span class="type-signature"></span>data<span class="type-signature"> :T</span></h4>




<div class="description">
    <p>the database entity this event was generated for, e.g. an entity that just entered or left the result set</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line16">line 16</a>
    </li></ul></dd>
...
<h4 class="name" id="date"><span class="type-signature"></span>date<span class="type-signature"> :Date</span></h4>




<div class="description">
    <p>server-time from the instant at which the event was generated</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line65">line 65</a>
    </li></ul></dd>
...
<div class="description">
    <p>for sorting queries only: the position of the matching entity in the ordered result (-1 for non-matching entities)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line57">line 57</a>
    </li></ul></dd>
...
<h4 class="name" id="initial"><span class="type-signature"></span>initial<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>a boolean value indicating whether this event reflects the matching status at query time (true) or a recent change<br>data change (false)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line48">line 48</a>
    </li></ul></dd>
...
<h4 class="name" id="matchType"><span class="type-signature"></span>matchType<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>indicates how the transmitted entity relates to the query result.<br> Every event is delivered with one of the following match types:<br> <ul><br> <li> 'match': the entity matches the query. </li><br> <li> 'add': the entity entered the result set, i.e. it did not match before and is matching now. </li><br> <li> 'change': the entity was updated, but remains a match </li><br> <li> 'changeIndex' (for sorting queries only): the entity was updated and remains a match, but changed its position<br> within the query result </li><br> <li> 'remove': the entity was a match before, but is not matching any longer </li><br> </ul></p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line32">line 32</a>
    </li></ul></dd>
...
<h4 class="name" id="operation"><span class="type-signature"></span>operation<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>the operation by which the entity was altered ('insert', 'update' or 'delete'; 'none' if unknown or not applicable)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line24">line 24</a>
    </li></ul></dd>
...
<h4 class="name" id="target"><span class="type-signature"></span>target<span class="type-signature"> :<a href="query.Node.html">query.Node.&lt;T></a></span></h4>




<div class="description">
    <p>the query on which .eventStream([options]) was invoked</p>
</div>
...
<span class="param-type"><a href="query.Node.html">query.Node.&lt;T></a></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_types.js.html">lib/types.js</a>, <a href="lib_types.js.html#line8">line 8</a>
    </li></ul></dd>
