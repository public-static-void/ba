...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Class: PushMessage</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
          ...
          <ul class="nav bs-sidenav">
                  ...
                  <li class="active">
                      ...
                      <ul class="nav">
                          ...
                          <li class="active"><a href="util.PushMessage.html" class="nav-name">PushMessage</a></li>
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Class: PushMessage</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="util.html">util</a>.</span>PushMessage<span class="signature">(devices<span class="signature-attributes">opt</span>, message<span class="signature-attributes">opt</span>, subject<span class="signature-attributes">opt</span>, options<span class="signature-attributes">opt</span>, badge<span class="signature-attributes">opt</span>, data<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>PushMessages are used to send a push notification to a set of devices</p></div>
...
<article>
    ...
    <h4 class="name" id="PushMessage"><span class="type-signature"></span>new PushMessage<span class="signature">(devices<span class="signature-attributes">opt</span>, message<span class="signature-attributes">opt</span>, subject<span class="signature-attributes">opt</span>, options<span class="signature-attributes">opt</span>, badge<span class="signature-attributes">opt</span>, data<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Iterable.&lt;binding.Entity></span>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>The options object which can contain additional information and data</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The icon of the push message</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The badge for iOS or Web Push devices</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>nativeBadge</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The number for iOS and Android devices which will occur on the top right of<br>the icon</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>webBadge</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The web badge is the small monochrome icon which will occur on small devices<br>(web push only)</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>An image of the push message (web push only)</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Actions that the user can invoke and interact with (web push only)</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Defines which direction the text should be displayed (web push only)</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The sound of an incoming push message (web push only)</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The tag of the push message where messages are going to be collected (web push only)</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>vibrate</code></td>
...
<span class="param-type">Array.&lt;number></span>
            ...
            <td class="description last"><p>The vibrate property specifies a vibration pattern for the device's<br>vibration</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>renotify</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>The renotify option makes new notifications vibrate and play a sound<br>(web push only)</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>requireInteraction</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>The requireInteraction option lets stay the push message until the<br>user interacts with it (web push only)</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>The silent option shows a new notification but prevents default behavior<br>(web push only)</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line10">line 10</a>
    </li></ul></dd>
...
<h4 class="name" id="devices"><span class="type-signature">(readonly) </span>devices<span class="type-signature"> :Set.&lt;model.Device></span></h4>
...
<span class="param-type">Set.&lt;model.Device></span>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line50">line 50</a>
    </li></ul></dd>
...
<h4 class="name" id="message"><span class="type-signature">(readonly) </span>message<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>Push notification message</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line57">line 57</a>
    </li></ul></dd>
...
<h4 class="name" id="subject"><span class="type-signature">(readonly) </span>subject<span class="type-signature"> :string</span></h4>




<div class="description">
    <p>Push notification subject</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line64">line 64</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="addDevice"><span class="type-signature"></span>addDevice<span class="signature">(device)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<span class="param-type"><a href="binding.Entity.html">binding.Entity</a></span>
            ...
            <td class="description last"><p>will be added to the device set to receive the push notification</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line96">line 96</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_PushMessage.js.html">lib/util/PushMessage.js</a>, <a href="lib_util_PushMessage.js.html#line108">line 108</a>
    </li></ul></dd>
