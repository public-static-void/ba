...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Home</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
    ...
    <h2 style="margin-left: 0">baqend 2.14.1</h2>
    <p>To install, embed our CDN-hosted Baqend SDK script into your page.</p>
    <pre>&lt;script src="//www.baqend.com/js-sdk/2.14.1/baqend.min.js"&gt;&lt;/script&gt;</pre>
