...
<head>
    <meta charset="utf-8">
    <title>Baqend JavaScript SDK 2.14.1 - Class: DeviceFactory</title>
...
<div class="box gray pt-32 pb-32">
  <div class="container">
          ...
          <ul class="nav bs-sidenav">
                  ...
                  <li class="active">
                      ...
                      <ul class="nav">
                          ...
                          <li class="active"><a href="binding.DeviceFactory.html" class="nav-name">DeviceFactory</a></li>
    ...
    <div class="col-md-12" id="main">
      <div class="content">
        <h1 class="page-title">Class: DeviceFactory</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="binding.html">binding</a>.</span>DeviceFactory<span class="signature">(properties<span class="signature-attributes">opt</span>, &hellip;arguments)</span><span class="type-signature"> &rarr; {<a href="model.Device.html">model.Device</a>}</span></h2>
...
<article>
    ...
    <h4 class="name" id="DeviceFactory"><span class="type-signature"></span>new DeviceFactory<span class="signature">(properties<span class="signature-attributes">opt</span>, &hellip;arguments)</span><span class="type-signature"> &rarr; {<a href="model.Device.html">model.Device</a>}</span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line6">line 6</a>
    </li></ul></dd>
...
<h4 class="name" id="isRegistered"><span class="type-signature">(readonly) </span>isRegistered<span class="type-signature"> :boolean</span></h4>




<div class="description">
    <p>Returns true if the devices is already registered, otherwise false.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line29">line 29</a>
    </li></ul></dd>
...
<h4 class="name" id="me"><span class="type-signature">(readonly) </span>me<span class="type-signature"> :<a href="model.Device.html">model.Device</a></span></h4>




<div class="description">
    <p>The current registered device, or <code>null</code> if the device is not registered</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line20">line 20</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="loadWebPushKey"><span class="type-signature"></span>loadWebPushKey<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;ArrayBuffer>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line37">line 37</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>The public VAPID Web Push subscription key</p>
</div>
...
<span class="param-type">Promise.&lt;ArrayBuffer></span>
    ...
    <h4 class="name" id="push"><span class="type-signature"></span>push<span class="signature">(pushMessage, doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;*>}</span></h4>
...
<table class="params table">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>pushMessage</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="util.PushMessage.html">util.PushMessage</a></span>
            ...
            <td class="description last"><p>to send an push notification.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line83">line 83</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;*></span>
    ...
    <h4 class="name" id="PushMessage"><span class="type-signature"></span>PushMessage<span class="signature">(devices<span class="signature-attributes">opt</span>, message<span class="signature-attributes">opt</span>, subject<span class="signature-attributes">opt</span>, sound<span class="signature-attributes">opt</span>, badge<span class="signature-attributes">opt</span>, data<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {<a href="util.PushMessage.html">util.PushMessage</a>}</span></h4>
...
<span class="param-type">Set.&lt;binding.Entity></span>
|
...
<span class="param-type">Array.&lt;binding.Entity></span>
            ...
            <td class="description last"><p>The Set of device references which<br>will receive this push notification.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The message of the push notification.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The subject of the push notification.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The file reference of the sound file as a string. The device uses this file as the<br>notification sound.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The badge count.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The data object which can contain additional information.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line88">line 88</a>
    </li></ul></dd>
...
<span class="param-type"><a href="util.PushMessage.html">util.PushMessage</a></span>
    ...
    <h4 class="name" id="register"><span class="type-signature"></span>register<span class="signature">(os, tokenOrSubscription, doneCallback, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;model.Device>}</span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>tokenOrSubscription</code></td>
...
<span class="param-type">Subscription</span>
            ...
            <td class="description last"><p>The FCM device token, APNS device token or WebPush subscription</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line43">line 43</a>
    </li></ul></dd>
...
<span class="param-type">Promise.&lt;model.Device></span>
    ...
    <h4 class="name" id="register"><span class="type-signature"></span>register<span class="signature">(os, tokenOrSubscription, device<span class="signature-attributes">opt</span>, doneCallback<span class="signature-attributes">opt</span>, failCallback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;model.Device>}</span></h4>
...
<span class="param-type">PushSubscription</span>
            ...
            <td class="description last"><p>The FCM device token, APNS device token or WebPush<br>subscription</p></td>
        </tr>
...
<span class="param-type"><a href="model.Device.html">model.Device</a></span>
            ...
            <td class="description last"><p>An optional device entity to set custom field values</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_binding_DeviceFactory.js.html">lib/binding/DeviceFactory.js</a>, <a href="lib_binding_DeviceFactory.js.html#line66">line 66</a>
    </li></ul></dd>
